<template>
  <b-container fluid="md" class="py-5" v-if="load">
    ...
    <b-form @submit="onSubmit" @reset="onReset" v-if="show" class="py-5">
    	...
    	<!-- safety zone name -->
    	<b-form-group id="input-group-ower" label="Safety Zone Name:" label-for="input-ower">
	        <b-form-input
	          id="input-ower"
	          v-model="form.name"
	          required
      	...
      	<!-- owner name -->
    	<b-form-group id="input-group-owner" label="Your Name:" label-for="input-owner">
	        <b-form-input
	          id="input-owner"
	          v-model="form.owner"
	          required
		    ...
		    <b-form-valid-feedback :state="owner_validation"></b-form-valid-feedback>
      	</b-form-group>

      	<!-- owner CID -->
      	<b-form-group id="input-group-owerCID" label="Your Citizen ID:" label-for="input-owerCID">
	        <b-form-input
	          id="input-owerCID"
		    ...
		    <b-form-valid-feedback :state="ownerCID_validation"></b-form-valid-feedback>
      	</b-form-group>

      	<!-- lat-lng -->
      	<b-form-row id="input-group-latlng">
	      	<b-form-group id="input-group-lat" label="Latitude:" label-for="input-lat">
		        <b-form-input
		          id="input-lat"
		    ...
		    <b-form-valid-feedback :state="lat_validation"></b-form-valid-feedback>
	      	</b-form-group>


	      	<b-form-group id="input-group-lng" label="Longitude:" label-for="input-lng">
		        <b-form-input
		          id="input-lng"
		    ...
		    <b-form-valid-feedback :state="lng_validation"></b-form-valid-feedback>
	      	</b-form-group>

      	</b-form-row>
      	<b-button variant="secondary" class="btn-latlng mb-3" @click="myPoint">Get Your Point</b-button>

      	<b-form-row id="input-group-air_con-row">
	      	<!-- air conditioner -->
	    	<b-form-group id="input-group-air_con" label="Air Conditioner:" 
	    	label-for="input-air_con">
	      	...
	      	<!-- air purifier -->
	    	<b-form-group id="input-group-air_pur" label="Air Purifier:" 
      	...
      	<!-- overnight and room -->
		    ...
		    >
	      	...
	      	<!-- capacity -->
	    	<b-form-group id="input-group-capacity" label="Capacity:" 
	    ...
	    <!-- type -->
	    <b-form-group id="input-group-type" label="Type:" 
	   	label-for="input-type">
		    <b-form-select v-model="form.type" :options="type_options" required></b-form-select>
	 	</b-form-group>

      	<!-- address -->
      	<b-form-group id="input-group-address" label="Address:" label-for="input-address" class="mt-4">
	        <b-form-textarea
		      id="address"
		    ...
		    <b-form-valid-feedback :state="address_validation"></b-form-valid-feedback>
      	</b-form-group>
		    ...
		    <b-card class="mb-4">
			    ...
			    <b-row>
			    	<b-col lg="10">
					    <b-form-file 
					    	no-drop
						    accept="image/jpeg, image/png" v-model="cover_img" 
						    ref="file-input" class="mb-2 img-upload" 
						    placeholder="Choose cover image" required
						    @change="previewImg($event,'cover')"
						    :state="Boolean(cover_img)"
					    />
					</b-col>
					<b-col lg="2">
						<b-button @click="cover_img = null,form.cover_img_url= ''" 
						class="btn-reset mb-3">Reset</b-button>
						</b-col>
				</b-row>
		    ...
		    <b-card>
			    ...
			    <b-row>
			    	...
			    	<b-col lg="10">				    
					    <b-form-file
					    	no-drop 
						    accept="image/jpeg, image/png" v-model="inside_img1" 
							ref="file-input" class="mb-2 img-upload" 
							placeholder="Choose first inside image" required
							@change="previewImg($event,'inside1')"
							:state="Boolean(inside_img1)"
						/>
					</b-col>
					<b-col lg="2">
						<b-button @click="inside_img1 = null,form.inside_img1_url = ''" 
						class="btn-reset mb-3">Reset</b-button>
					</b-col>
				</b-row>
				...
				<b-row>
			    	...
			    	<b-col lg="10"> 
						...
						<b-form-file 
							no-drop
							accept="image/jpeg, image/png" v-model="inside_img2" 
							ref="file-input" class="mb-2 img-upload" 
							placeholder="Choose second inside image" required
							@change="previewImg($event,'inside2')"
							:state="Boolean(inside_img2)"
						/>
					</b-col>
					<b-col lg="2">
						<b-button @click="finside_img2 = null,form.inside_img2_url = ''" 
						class="btn-reset mb-3">Reset</b-button>
					</b-col>
				</b-row>
				...
				<b-row>
			    	...
			    	<b-col lg="10">						
						<b-form-file 
							accept="image/jpeg, image/png" v-model="inside_img3" 
							ref="file-input" class="mb-2 img-upload" 
							placeholder="Choose third inside image" required
							@change="previewImg($event,'inside3')"
							:state="Boolean(inside_img3)"
						/>
					</b-col>
					<b-col lg="2">
						<b-button @click="inside_img3 = null,form.inside_img3_url = ''" 
						class="btn-reset mb-3">Reset</b-button>
					</b-col>
				</b-row>
				...
				<div id="inside-img">
					  <b-row>
					    <b-col md>
					      <b-img :src="form.inside_img1_url" fluid class="mb-2"></b-img>
					    </b-col>
					    <b-col md>
					      <b-img :src="form.inside_img2_url" fluid class="mb-2"></b-img>
					    </b-col>
					    <b-col md>
					      <b-img :src="form.inside_img3_url" fluid class="mb-3"></b-img>
					    </b-col>
					  </b-row>
				</div>
		    </b-card>
  	...
  	export default {
	    ...
	    methods: {
	    	insert_sf_info(sf_id){
	    		this.$fireDb.ref(`safetyZone/sf_user_info/${sf_id}`).set({
		        	name: this.form.name,
			...
			async insert_sf(sf_id){
	    		...
	    		await sf.once('value').then( async (data)=> { //set index
					index = await data.numChildren()
		        })

		        await sf.child(index).set({
					sf_id: sf_id,
					name: this.form.name,
					type: this.form.type,
					lat: this.form.lat_lng.lat,
	    	...
	    	async addOwner(sf_id){
	    		...
	    		await owner.once('value').then( (data)=> { //set index
		        	index = data.numChildren()
		        })

		        await owner.child(index).set({
					sf_id: sf_id,
	    	...
	    	onSubmit(evt) {
		        ...
		        amountOnDB.once('value')
		        .then( (data)=> { //set safety zone id
		        	amount = data.val()
		        	amount = amount+1
		        	sf_id += amount
		        }) 
...
<style scoped>
	...
	#input-group-lat, #input-group-lng , 
	#input-group-air_con, #input-group-air_pur,
	#input-group-room, #input-group-capacity,
	#input-group-type{
		width: 35%;
    	margin-right: 5%;
	}
	...
	#input-tel, #input-email, #input-line, #input-fb{
		width: 70%;
    	margin-right: 5%;
	}
